...
const handleNewSnapshotFromUserAction =
  (newSnapshot: GameSnapshot, snapshotUpdateType: SnapshotUpdateType, draggedCardScreenLocation: DraggedCardScreenLocation = null) =>
  (dispatch: Function, getState: () => RootState) => {
    ...
    const transitionTemplates = createTransitionTemplates(differences, snapshotUpdateType, draggedCardScreenLocation);
