...
export const SpecialsCardsColumn = forwardRef<RefMap, SpecialsCardsColumnProps>(
    ({ cards, cardStyles, cardType, columnIndex, specialsZoneId, startingIndex }, refMap) => {
        const { highlights, draggedHandCard, draggedOver } = useSelector(
        ...
        const isHighlighted =
            highlights.includes(specialsZoneId) &&
            draggedHandCard?.guestCardType === specialsColumnType;
        ...
        const isDraggedOver =
            isHighlighted &&
            draggedOver?.id === specialsZoneId &&
            draggedOver?.index === startingIndex;
        const cardsNotAmongHighlights =
            highlights.includes(specialsZoneId) &&
            draggedHandCard?.specialsCardType !== specialsColumnType;
                                        ...
                                        <div
                                            ...
                                            style={{
                                                ...
                                                boxShadow: isHighlighted
                                                    ? "0px 0px 30px 30px yellowgreen"
                                                    : "",
                                                transition:
                                                    "background-color 180ms, box-shadow 180ms, left 180ms",
                                                position: "absolute",
